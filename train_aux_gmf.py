...
from aux_gmf import aux_gmf_model
from time import time
from Dataset import Dataset
from evaluate_aux import evaluate_model
...
if __name__ == '__main__':
    ...
    print("aux_gmf arguments: %s" %(args))
    ...
    # creating model
    model = aux_gmf_model(args.num_users, args.num_items, factor=args.num_factors, layers=args.layers, reg_mf=args.reg_mf, emb_reg=args.emb_reg, reg_layers=args.reg_layers)
    ...
    print("End aux_gmf. Best Iteration %d:  HR = %.4f, NDCG = %.4f. " %(best_iter, best_hr, best_ndcg))
