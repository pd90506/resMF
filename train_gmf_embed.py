...
if __name__ == '__main__':
    ...
    # creating model
    model = gmf_embed_model(args.num_users, args.num_items, factor=args.num_factors,reg=args.emb_reg)
    ...
    print("End gmf_embed. Best Iteration %d:  HR = %.4f, NDCG = %.4f. " %(best_iter, best_hr, best_ndcg))