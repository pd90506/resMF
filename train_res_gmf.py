...
if __name__ == '__main__':
    ...
    # creating model
    model = res_gmf_model(args.num_users, args.num_items, factor=args.num_factors, layers=args.layers, reg_mf=args.reg_mf, emb_reg=args.emb_reg, reg_layers=args.reg_layers)
    ...
    print("End resMF. Best Iteration %d:  HR = %.4f, NDCG = %.4f. " %(best_iter, best_hr, best_ndcg))
